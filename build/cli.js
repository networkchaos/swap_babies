...
async function interactiveCLI() {
    ...
    try {
        ...
        console.log("\n🔄 Initiating STK Push...");
        await (0, server_1.triggerStkPushCLI)(phone, amount, chain, token, recipient);
    }
    catch (error) {
...
(0, yargs_1.default)((0, helpers_1.hideBin)(process.argv))
    ...
    await (0, server_1.triggerStkPushCLI)(argv.phone, argv.amount, argv.chain, argv.token, argv.recipient);
})
    .demandCommand(1)
    .help()
    .parse();
